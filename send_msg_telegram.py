...
async def send_msg(
    ...
    return await main(chat_id=chat_id, text=text, message_id=reply_to_message_id)
...
async def send_sticker(
    ...
    return await main(chat_id=chat_id, sticker=sticker, message_id=reply_to_message_id)
...
async def send_video(
    ...
    return await main(chat_id=chat_id, video=video,
